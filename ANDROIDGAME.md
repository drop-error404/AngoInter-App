...
class QuizActivity : AppCompatActivity() {
    ...
    private fun setupRecyclerView() {
        optionAdapter = QuizOptionAdapter(emptyList()) { position, answer ->
    ...
    private fun displayQuestion() {
        ...
        val progress = ((quizManager.getCurrentIndex()) * 100) / quizManager.getTotalQuestions()
    ...
    private fun updateTimerUI() {
        ...
        val percentage = ((timeLeftInMillis * 100) / totalTime).toInt()
    ...
    private fun timeUp() {
        AlertDialog.Builder(this, R.style.Theme_AngoNurseGame)
...
- **Erro de Gradle**: Verifique a versão do Gradle no `build.gradle`
- **Erro de SDK**: Certifique-se que tem o SDK 36 instalado
- **Erro de Kotlin**: Atualize o plugin Kotlin para 1.9.22
